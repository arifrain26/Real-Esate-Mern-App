...
export default function Profile() {
  ...
  const [userListigs, setUserListings] = useState([]);
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <button
        ...
        className="text-white w-full p-3 rounded-lg bg-blue-500"
      >
        Show Listing
      </button>
      {userListigs && userListigs.length > 0 && (
        <div className="flex flex-col gap-4">
          <h1 className="font-semibold text-center mt-7 text-2xl">
            Your Listing
          </h1>
          {userListigs.map((listing) => (
            <div
              key={listing._id}
